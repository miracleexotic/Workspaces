...
LibAgent.prototype.startServiceEndpoint = function (entryPointType, request) {
  return  this.agent.startServiceEndpoint(entryPointType, request);
};
...
LibAgent.prototype.stopServiceEndpoint = function (sepGuid) {
  this.agent.stopServiceEndpoint(sepGuid);
};
...
LibAgent.prototype.getNodeId = function () {
  return this.agent.getNodeId();
};
...
LibAgent.prototype.addErrorToEndpoint = function (sepGuid, name, message) {
  return this.agent.addErrorToEndpoint(sepGuid, name, message);
};
...
LibAgent.prototype.registerNodeProperty = function (property, value) {
  return this.agent.registerNodeProperty(property, value);
};

LibAgent.prototype.getNodeProperty = function (property) {
  return this.agent.getNodeProperty(property);
};

LibAgent.prototype.filterLogMessage = function (msg) {
  return this.agent.filterLogMessage(msg);
};
